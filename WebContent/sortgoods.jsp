...
<%
	...
	//获取到商品总数
	int goodsCount =gc.getSortGoodsCount2(sortId);
	//获取总页数
	pageCount = gc.getSortGoodsCount(pageSize,sortId);
	//如果小于第一页，则显示第一页
	if(pageNow <= 0){
		pageNow = 1;
	}
	...
	ArrayList<GoodsInfo> agoods = gc.getSortGoods(pageSize,pageNow,sortId);
	if(agoods==null){
  ...
  <script type="text/javascript">
  	function pageGo(){
		...
		if(isNaN(pageNow.value)){
  		...
  		window.location.href="sortgoods.jsp?pageNow=" + pageNow.value;
  	}
  </script>
  <body>
  	<!-- 总层 -->
    <div id="sum">
    	...
    	<div id="search" class="seh">
			...
			<tr style="position: absolute;top: 720px;height: 40px;">       			
       			<td colspan="5">
       				<center>
       				<a href="sortgoods.jsp?pageNow=1"><img src="images/first.gif"></img></a>&nbsp;&nbsp;
       				<a href="sortgoods.jsp?pageNow=<%=pageNow-1 %>"><img src="images/back.gif"></img></a>
       				<font style="color: #8E8E8E; font-size: 12px;"><%=pageNow %>/<%=pageCount %></font>
       				<a href="sortgoods.jsp?pageNow=<%=pageNow+1 %>"><img src="images/next.gif"></img></a>&nbsp;&nbsp;
       				<a href="sortgoods.jsp?pageNow=<%=pageCount %>"><img src="images/last.gif"></img></a>
