...
<div id="container">
    <div id="right">
    	<div class="content">
       	  <div class="rtbd">
           	<div class="jyjl">
                	<h2><img src="admin/images/ibg1.jpg" />新闻管理</h2>
            </div>
                <table class="user" width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr onmousemove="this.style.backgroundColor='#ffffcc'" onmouseout="this.style.backgroundColor=''">
                    ...
                    <td>
						<a href="admin/newsupdate.jsp?newsId=<%=news.getNewsId() %>"><img alt="编辑新闻" src="admin/images/icon3.gif"></img></a>		
						| <a href="servlet/Admin_deleteNews?newsId=<%=news.getNewsId() %>" onclick="return confirm('确定要删除吗？')"><img alt="删除新闻" src="admin/images/icon4.gif"></img></a>
					</td>                    
                  </tr>
                  <%} %>
                   <tr>
                  		<td style="border-left:#CFE0F0 1px solid;" colspan="7">
                  			<a href="admin/news.jsp?pageNow=1">首页</a>
                  			<a href="admin/news.jsp?pageNow=<%=pageNow-1 %>">上一页</a>                  			
                  			<font style="color: red; font-size: 12px;"><%=pageNow %>/<%=pageCount %></font>
                  			<a href="admin/news.jsp?pageNow=<%=pageNow+1 %>">下一页</a>
                  			<a href="admin/news.jsp?pageNow=<%=pageCount %>">尾页</a>
