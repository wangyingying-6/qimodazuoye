...
<html>
  ...
  <body>
  	<form action="servlet/Admin_AddNewsServlef" method="post" onsubmit="return news()">
		<div id="container">
	   	 <div id="right">
	    	<div class="content">
	       	  <div class="rtbd">
	           	<div class="jyjl">
	              <h2><img src="admin/images/ibg1.jpg" />新闻添加</h2>
	            </div>
	        	<table class="tblist" width="100%" cellspacing="0" cellpadding="0">                       
	              <tr>
	               ...
	               <tr>
	                ...
	                <td><textarea name="newsContent" id="newsContent" cols="60" rows="10"></textarea></td>
	              </tr>
	              <tr>
	              	<td width="200px;"></td>
