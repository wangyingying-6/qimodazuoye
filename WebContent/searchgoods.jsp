...
<%
	...
	//获取搜索结果总数
	int goodsCount =gc.getSearchGoodsCount2(GoodsName);
	//获取总页数
	pageCount = gc.getSearchGoodsCount(pageSize,GoodsName);
	//如果小于第一页，则显示第一页
	if(pageNow <= 0){
		pageNow = 1;
	}
	...
	ArrayList<GoodsInfo> agoods = gc.SearchGoods(pageSize,pageNow,GoodsName);
	if(agoods==null){
...
<html>
  <head>
	...
	<style type="text/css">
		...
		.gg,.sortpic{position:absolute; left:4%;width:950px;height:130px; top:943px; border-top:#D0D0D0 0px solid; border-bottom:#D0D0D0 0px solid;}
		/*==显示搜索商品==*/
		.seh{width:930px; border-left:#D0D0D0 1px solid; border-right:#D0D0D0 1px solid; margin:0px auto; height:37px; line-height:20px;}
		.seh,.sortpic{position:absolute; left:28.6%;width:625px;height:763px; top:180px; border-top:#D0D0D0 1px solid; border-bottom:#D0D0D0 1px solid;}
  ...
  <script type="text/javascript">
  	function pageGo(){
		...
		if(isNaN(pageNow.value)){
  		...
  		window.location.href="searchgoods.jsp?pageNow="+pageNow.value+"&GoodsName=<%=GoodsName %>";
  	}
  </script>
  <body>
  	<!-- 总层 -->
    <div id="sum">
    	...
    	<div id="search" class="seh">
			...
			<tr style="position: absolute;top: 720px;height: 40px;">       			
       			<td colspan="5">
       				<center>
       				<a href="searchgoods.jsp?pageNow=1&GoodsName=<%=GoodsName %>"><img src="images/first.gif"></img></a>&nbsp;&nbsp;
       				<a href="searchgoods.jsp?pageNow=<%=pageNow-1 %>&GoodsName=<%=GoodsName %>"><img src="images/back.gif"></img></a>
       				<font style="color: #8E8E8E; font-size: 12px;"><%=pageNow %>/<%=pageCount %></font>
       				<a href="searchgoods.jsp?pageNow=<%=pageNow+1 %>&GoodsName=<%=GoodsName %>"><img src="images/next.gif"></img></a>&nbsp;&nbsp;
       				<a href="searchgoods.jsp?pageNow=<%=pageCount %>&GoodsName=<%=GoodsName %>"><img src="images/last.gif"></img></a>
        ...
        <!-- 网站底部信息--> 
  		<center>
   		<div id="db">
   			<div style="position:absolute;left: 40px;top: 1080px;"><img src="images/db1.jpg"></img></div>	
			<div style="position:absolute;left: 40px;top: 1125px;">
			 ●&nbsp;<a href="#">购物流程</a><br>
			 ●&nbsp;<a href="#">发票制度</a><br>
			 ●&nbsp;<a href="#">积分说明</a><br>
			 ●&nbsp;<a href="#">我的奥络</a><br>
			...
			<div style="position:absolute;left: 200px;top: 1125px;">
			 ●&nbsp;<a href="#">配送时间及运费</a><br>
			 ●&nbsp;<a href="#">加急快递</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
			 ●&nbsp;<a href="#">海外配送时间</a>&nbsp;&nbsp;&nbsp;<br>
			 ●&nbsp;<a href="#">验货与签收</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
			...
			<div style="position:absolute;left: 370px;top: 1125px;">
			 ●&nbsp;<a href="#">货到付款</a><br>
			 ●&nbsp;<a href="#">网上支付</a><br>
			 ●&nbsp;<a href="#">支票支付</a><br>
			 ●&nbsp;<a href="#">银行转帐</a><br>
			...
			<div style="position:absolute;left: 520px;top: 1125px;">
			 ●&nbsp;<a href="#">退换货政策</a><br>
			 ●&nbsp;<a href="#">退换货流程</a><br>
			 ●&nbsp;<a href="#">退货申请</a>&nbsp;&nbsp;&nbsp;<br>
			 ●&nbsp;<a href="#">换货申请</a>&nbsp;&nbsp;&nbsp;<br>
			...
			<div style="position:absolute;left:690px;top: 1125px;">
			 ●&nbsp;<a href="#">奥络礼品卡</a>&nbsp;<br>
			 ●&nbsp;<a href="#">商店街</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
			●&nbsp;<a href="#">积分兑换</a>&nbsp;&nbsp;&nbsp;&nbsp;<br>
			●&nbsp;<a href="#">手机奥络网</a>&nbsp;<br>
			...
			<div style="position:absolute;left:830px;top: 1125px;">
			 ●&nbsp;<a href="#">常见问题</a><br>
			 ●&nbsp;<a href="#">找回密码</a><br>
			 ●&nbsp;<a href="#">促销说明</a><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ●&nbsp;<a href="#">退订邮件/短信</a><br>
			 ●&nbsp;<a href="#">联系客服</a><br>
			 	...
			 	<div style="position:absolute;left:25px;top:1225px;"><a href="#"><img src="images/db2.jpg"></img></a></div>
			 	<div style="position:absolute;left:180px;top:1300px;">
