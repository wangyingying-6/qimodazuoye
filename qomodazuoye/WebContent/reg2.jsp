...
<html>
  ...
  <style type="text/css">
  	...
  	<script type="text/javascript">
		function tz(){
			window.location.href="reg.jsp?username=<%=username%>";
		}
		setInterval(tz, 5000);
	</script>
  </head>  
  <body>
    <div id="sum">  
    	...
    	<center>
    	 <div class="location">
       	  <div class="place">
           	  <h1>> <a href="index.jsp">首页</a> > 注册成功</h1>
          </div>
        </div>
        <div id="bd">
        	<div>        		
        		<img src="images/success.gif"></img><br/><br>
        		<font style="font-size: 15px;">您的会员名为：<font style="font-size: 15px;color: 00F"><%=username %></font></font>
        		<font style="font-size: 18px;color: #00F"></font>
        		<br><br><br><a href="reg.jsp?username=<%=username%>">正在自动跳转到登陆页面</a>
        	</div>
        </div>
        </center>  
        <!-- 网站底部界面 -->     
