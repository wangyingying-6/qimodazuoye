...
<html>
  <head>
	...
	<style type="text/css">
		...
		.sp,.sortpic{position:absolute; left:9%;width:198px;height:450px; top:183px; border-top:#D0D0D0 1px solid; border-bottom:#D0D0D0 1px solid;}
		...
		/*==显示搜索商品==*/
		.seh{width:930px; border-left:#D0D0D0 1px solid; border-right:#D0D0D0 1px solid; margin:0px auto; height:37px; line-height:37px;}
		.seh,.sortpic{position:absolute; left:28.6%;width:625px;height:760px; top:183px; border-top:#D0D0D0 1px solid; border-bottom:#D0D0D0 1px solid;}
</style>
  </head>  
  <body>
  	<!-- 总层 -->
    <div id="sum">
    	...
    	<div id="search" class="seh">
			<center><img src="images/sce.jpg"></img></center>
    	</div>
    	<!-- 网站商品快报 --> 
 		<div id="kb">
 			<div class="kb">
