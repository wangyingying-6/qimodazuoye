...
<html>
  ...
  <body>
    	...
    	<div id="logo">
    	<br/>
    	　　<a href="index.jsp" onfocus="this.blur()"><img src="images/logo.jpg"></img></a>
        ...
        <center>
        <div id="gwc">
       	 <div align="center"><a href="index.jsp" onfocus="this.blur()"><img src="images/empty_cart.png"></img></a></div>
        </div> 
        </center>
        <!-- 网站底部界面 -->     
   		<center>
