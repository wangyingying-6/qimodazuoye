...
<html>
  <head>
   ...
   <style type="text/css">
		...
		th{border: 0px;}
  		td{border: 0px;font-size: 15px;}
  		td a:hover{text-decoration: none;color: #00F}
		/*==顶部信息==*/
		.topreg{float:left;}
  ...
  <body>
    	...
    	<center>
    	 <div class="location">
       	  <div class="place">
           	  <h1>> <a href="index.jsp">首页</a> > 商城公告  > 新闻内容</h1>
				<span>					
						<a href="#"></a>
				</span>
          </div>
        ...
        <div id="news">
       	<table align="right" style="width: 100%;">
       		<tr style="line-height: 40px;">
       			<th><center><font style="font-size:20px;"><%=news.getNewstitle() %></font></center></th>
       		</tr>      		
       		<tr style="line-height: 30px;">
       			<td style=""><center>发布时间：<%=news.getNewsdate() %></center></td>
       		</tr>
       		<tr>
       			<td><%=news.getNewscontent() %></td>
       		</tr>
       		<tr align="center" style="line-height: 40px;">
       			<td><font style="color: rgb(0, 0, 255);">最新新闻</font></td>
       		</tr>
       		 <%
	        	UserCrtl uc = new UserCrtl();
	        	ArrayList<Admin_NewsInfo> zxnews =uc.selNews();
	        	for(Admin_NewsInfo an : zxnews){        	
        	 %>
        	 <tr align="center">        	 	 
        		<td><a href="news2.jsp?newsId=<%=an.getNewsId() %>"><%=an.getNewstitle() %></a></td>
        	</tr>
        	<%} %>
       	</table>    	
        </div>         
