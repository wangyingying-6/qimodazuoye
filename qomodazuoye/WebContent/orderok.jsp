...
<html>
  ...
  <body>
    	...
    	<center>
    	 <div class="location">
       	  <div class="place">
           	  <h1>&gt; <a href="index.jsp">首页</a> &gt; <a href="purchase.jsp">购物车</a> &gt;  商品付款</h1>
				<span>					
						<a href="#"></a>
				</span>
          </div>
        ...
        <div id="order">
       		...
       		<div id="orderok">
       			<br/>
       			<img src="images/pic_gongxi.gif"></img><br/><br/>       			
       			<table  border="1" style="width: 730px;">
       				<%
       					int userId =Integer.parseInt(request.getParameter("userId"));       					
       					OrderCtrl oc = new OrderCtrl();       					
       					OrderInfo order =oc.ToOrder(userId);
       					//商品总价
       				...
       				<tr>
       					<td align="center"><a href="goodsinfo.jsp?goodsId=<%=order.getGoodsId()%>" target="_"><font style="font-size: 12px"><%=order.getGoodsname() %></font></a></td>
       					<td align="center"><font style="font-size: 12px;color: red"><%=order.getGoodsprice() %></font></td>
       					<td align="center"><font style="font-size: 12px;color: red"><%=order.getGoodscarr() %></font></td>
       					<td align="center"><font style="font-size: 12px"><%=order.getGoodssl() %></font></td>
       				</tr>
       			</table><br/>
       			商品总价：￥<%=order.getGoodsprice() %> 元，配送费用：￥<%=order.getGoodscarr() %>元，共计：<font style="color: red">￥<%=sum %> 元</font> <br/><br/>
       			<hr noShade SIZE=0>
       			<div align="left" style="margin-left: 35px;">
       			您的订单号是： <font style="color: #d20a34"><%=order.getOrderId() %></font>　　　　您需要支付<font style="color: #d20a34"> ￥<%=sum %>元</font><br/><br/>
       			您完成以下付款后，我们将在承诺的时间内将您订购的商品发出，再次感谢您的惠顾！<br/><br/>
       			付款方式：<font style="color: #d20a34"> 余额支付</font><br/><br/>
       				...
       				<div align="left" style="margin-left: 200px;">
       					...
       					　　　　　<input class="btnbg" type="submit" value=""><br/>
       				</div>
       				</form>
				</div>
       			<div align="right">
