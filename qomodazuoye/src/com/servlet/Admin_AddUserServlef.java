...
public class Admin_AddUserServlef extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String userpwd =request.getParameter("admin-userPwd");
		
		au.setAdmin_username(username);
		au.setAdmin_userpwd(userpwd);
		int res=ac.addAdmin_User(au);
		if(res>0){
			out.print("<script>alert('添加成功！');window.location.href='../admin/admin_user.jsp';</script>");
		}else{
