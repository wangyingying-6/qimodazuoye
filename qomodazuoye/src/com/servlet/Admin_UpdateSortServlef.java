...
public class Admin_UpdateSortServlef extends HttpServlet {
	 ...
	 */
	public Admin_UpdateSortServlef() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int res =ac.updateGoodsSort(sort);
		if(res>0){
			out.print("<script>alert('修改成功！');window.location.href='../admin/category.jsp';</script>");
		}else{
