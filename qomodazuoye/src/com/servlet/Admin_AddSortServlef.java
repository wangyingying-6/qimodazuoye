...
public class Admin_AddSortServlef extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int res =ac.addGoodsSort(sort);
		if(res>0){
			out.print("<script>alert('添加成功！');window.location.href='../admin/category.jsp';</script>");
		}else{
